...
*/
	...
	GUI_DisString_EN(25, 25, "SensoriumLab"   , &Font12, FONT_BACKGROUND, WHITE);
//	GUI_DisString_EN(28, 35, "Electronic"  , &Font12, FONT_BACKGROUND, WHITE);
	GUI_DisString_EN(25, 45, "H2O detector", &Font12, FONT_BACKGROUND, WHITE);
	
	sprintf(tmp,"Version=%2u.%02u",SIN_VERSION/100,SIN_VERSION%100);

	GUI_DisString_EN(50, 85, tmp, &Font8, FONT_BACKGROUND, WHITE);
//	printf("Showing...\r\n");
	OLED_Display();
	Driver_Delay_ms(700);
}
